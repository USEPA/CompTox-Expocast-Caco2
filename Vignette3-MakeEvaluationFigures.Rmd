...
print(FigCacoPredPeff)
    ggsave(FigCacoPredPeff, file = paste0(loc.wd, "/results_for_paper/FigCacoPredPeff.tiff"),
...
print(FigCacoPredFbioKim)
    ggsave(FigCacoPredFbioKim, file = paste0(loc.wd, "/results_for_paper/FigCacoPredFbioKim.tiff"),
         height = 3, width = 3, dpi = 600, compression = "lzw")
```
...
print(FigCacoPredFabs)
    ggsave(FigCacoPredFabs, file = paste0(loc.wd, "/results_for_paper/FigCacoPredFabs.tiff"),
         height = 3, width = 3, dpi = 600, compression = "lzw")
```
...
load(file=paste0(loc.wd, "/r_data/processed/caco2-invivo-compare2.RData"))    
  ...
  ggsave(FigCacoPredFgut, file = paste0(loc.wd, "/results_for_paper/FigCacoPredFgut.tiff"),
         height = 3, width = 3, dpi = 600, compression = "lzw")
```
...
```{r make_httk_Fhep_fig}
  ...
  ggsave(FighttkPredFhep, file = paste0(loc.wd, "/results_for_paper/FighttkPredFhep.tiff"),
         height = 3, width = 3, dpi = 600, compression = "lzw")
```
...
```{r make_httk_FhepFbio_fig}
  ...
  ggsave(FigOldhttkPredFbio, 
         file = paste0(loc.wd, "/results_for_paper/FigoldhttkPredFbio.tiff"),
         height = 3, width = 3, dpi = 600, compression = "lzw")
```
...
```{r make_Caco_Fabs_Varma_fig}
  ...
  ggsave(FigCacoPredFbioVarma, file = paste0(loc.wd, "/results_for_paper/FigCacoPredFbioVarma.tiff"),
         height = 3, width = 3, dpi = 600, compression = "lzw")
```
...
```{r make_CacoFabsRat_fig}
  ...
  ggsave(FigCacoPredFbioRat, file = paste0(loc.wd, "/results_for_paper/FigCacoPredFbioRat.tiff"),
         height = 3, width = 3, dpi = 600, compression = "lzw")
```
...
```{r make_Caco_Fabs_All_fig}
  ...
  ggsave(FigCacoPredFbioAll, 
         file = paste0(loc.wd, 
                       "/results_for_paper/FigCacoPredFbioAll.tiff"),
         height = 3, width = 3, dpi = 600, compression = "lzw")
```
...
```{r make_admet_Fabs_fig}
  ...
  ggsave(FigADMetPredFbio, 
         file = paste0(loc.wd, 
                       "/results_for_paper/FigADMetPredFbio.tiff"),
         height = 3, width = 3, dpi = 600, compression = "lzw")
```
...
tiff(file = paste0(loc.wd, "/results_for_paper/FigCacoPredFbioComponents.tiff"),
...
# Annotate chemical class:   
  ...
  print(FigQSPRPredPab)
    ggsave(FigQSPRPredPab, file = paste0(loc.wd, 
                                         "/results_for_paper/FigQSPRPredPab.tiff"),
         height = 3, width = 3, dpi = 600, compression = "lzw")
```
...
```{r make_qspr_peff_fig}
  ...
  ggsave(FigQSPRPredPeff, file = 
           paste0(loc.wd, "/results_for_paper/FigQSPRPredPeff.tiff"),
         height = 3, width = 3, dpi = 600, compression = "lzw")
```
```{r make_QSPR_Fbio_kim_fig}
  ...
  ggsave(FigQSPRPredFbioKim, file = 
           paste0(loc.wd, "/results_for_paper/FigQSPRPredFbioKim.tiff"),
         height = 3, width = 3, dpi = 600, compression = "lzw")
```
...
```{r make_QSPR_Fabs_fig}
  ...
  ggsave(FigQSPRPredFabs, file = 
           paste0(loc.wd, "/results_for_paper/FigQSPRPredFabs.tiff"),
         height = 3, width = 3, dpi = 600, compression = "lzw")
```
...
```{r make_QSPR_Fgut_fig}
  ...
  ggsave(FigQSPRPredFgut, file = 
           paste0(loc.wd, "/results_for_paper/FigQSPRPredFgut.tiff"),
         height = 3, width = 3, dpi = 600, compression = "lzw")
```
...
```{r make_QSPR_Fhep_fig}
  ...
  ggsave(FigQSPRPredFhep, file = 
           paste0(loc.wd, "/results_for_paper/FigQSPRPredFhep.tiff"),
         height = 3, width = 3, dpi = 600, compression = "lzw")
```
...
```{r make_QSPR_Fbio_Varma_fig}
  ...
  ggsave(FigQSPRPredFbioVarma, 
         file = paste0(loc.wd, 
                       "/results_for_paper/FigQSPRPredFbioVarma.tiff"),
         height = 3, width = 3, dpi = 600, compression = "lzw")
```
# Fbio using both Kim et al. (2014) and Varma et al. (2010)
```{r make_QSPR_Fbio_all_fig}
  ...
  ggsave(FigQSPRPredFbioAll, file = 
         paste0(loc.wd, "/results_for_paper/FigQSPRPredFbioAll.tiff"),
         height = 3, width = 3, dpi = 600, compression = "lzw")
```
