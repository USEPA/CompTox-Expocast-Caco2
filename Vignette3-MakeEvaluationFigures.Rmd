...
caco2.perchem[,c("Fbio.oral","Fabs.oral","Fgut.oral","Fhep.oral") :=
                ifelse(dtxsid%in%get_cheminfo(info="dtxsid"),
...
ggarrange(FigPredFabsHist, FigPredFgutHist, FigPredFhepHist, FigPredFbioHist
          labels = c("A", "B", "C", "D"),
          ncol = 2, nrow = 2,
          common.legend = TRUE, legend = "bottom")
