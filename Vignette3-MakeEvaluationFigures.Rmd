...
Qintesttransport <- 0.5
   ...
   # Qgut Model -- Yang et al. (2007) equation 5:
        .[,fgh_qg:=Qguth/(Qguth+ fuph.adj*cluh_gut/rb2ph)*Qguth/(Qguth+Qintesttransport)] %>% 
        .[,fgr_qg:=Qgutr/(Qgutr + fupr.adj*clur_gut/rb2pr)*Qguth/(Qguth+Qintesttransport)] %>%
...
```{r make_httk_Fhep_fig}
  ...
  ggsave(FighttlPredFhep, file = paste0(loc.wd, "/r_data/results_for_paper/FighttkPredFhep.tiff"),
         height = 3, width = 3, dpi = 600, compression = "lzw")
```
