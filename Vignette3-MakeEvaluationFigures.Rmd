...
save(invivo.table,
     file=paste0(loc.wd, "/r_data/processed/caco2-invivo-compare-fbioall.RData"))
...
invivo.table <- fbio.table
save(invivo.table,
     file=paste0(loc.wd, "/r_data/processed/qspr-invivo-compare-fbioall.RData"))
...
evaluations["Peff",c("In Vivo","Predicted","Reference","Data")] <- 
  c("mpeff_lit","peffh","Lanevskij and Didziapetris (2019)",
    "/r_data/processed/caco2-invivo-compare.RData")
