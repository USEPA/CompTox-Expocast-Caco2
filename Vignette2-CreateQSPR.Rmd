...
#                   alpha=0.2, position="identity")+
  ...
  #                    ymin = 130,ymax = 130,xmax = -3, xmin = -3)
    ...
    ggsave(FigPabSourceHist, file = paste0(loc.wd, "/results_for_paper/Fig_TrainSet_histogram.tiff"),
...
FigRFE <- ggplot(rfeClass$results) + 
  ...
  geom_vline(xintercept=num.opt.desc, color="blue",linetype="dashed")
ggsave(FigRFE, 
       file = paste0(loc.wd, "/results_for_paper/Fig_RFE.tiff"),
...
tiff(file = paste0(loc.wd, "/results_for_paper/Fig_VarImportance.tiff"),
