...
save(use.dt, measured.chems, file = paste0(loc.wd, "/r_data/AEDtable.RData"))
```
...
save(aed.full2,file=paste0(loc.wd, "/r_data/BERtable.RData"))
```
...
ggsave(FigBERleg, 
       file = paste0(loc.wd,
                       "/r_data/results_for_paper/BERrankmeascaco2.tiff"),
       dpi = 600, height = 5, width = 7.5, compression = "lzw")
```
...
ggsave(FigBERleg, 
       file = paste0(loc.wd,
                       "/r_data/results_for_paper/BERrankallcaco2.tiff"),
       dpi = 600, height = 5, width = 7.5, compression = "lzw")
```
```{r multipanelBER}
...
tiff(file = paste0(loc.wd, "/r_data/results_for_paper/FigTwoPanelBER.tiff"),
...
write.csv(low.fabs.table,file=paste0(loc.wd,"/r_data/results_for_paper/Tablepoorlyabsorbedchemcials.csv"))
```