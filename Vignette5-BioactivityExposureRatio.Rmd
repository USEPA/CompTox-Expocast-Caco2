...
print(paste("We are assuming that systemic bioavailability of an oral dose is a function of three processes: first-pass hepatic metabolism (independent of gut permeability), gut absorption, and gut metabolism. Since HTTK already included first-pass hepatic metabolism, shifts in the predictions of HTTK will be due to only gut absorption (no longer 100%) and gut metabolims (no longer zero).",
