...
print(paste("We are assuming that systemic bioavailability of an oral dose is a function of three processes: first-pass hepatic metabolism (independent of gut permeability), gut absorption, and gut metabolism. HTTK already included first-pass hepatic metabolism either by modeling flow from the gut through the liver before it reaches systemic circulation or by multiplying the absorbed dose by Fhep. Therefore, shifts in the predictions of HTTK will be due to only gut absorption (no longer 100%) and gut metabolims (no longer zero).",
            "For the chemcials where we can calculate BER the median value of Fabs is predicted to be",
...
css.table[,"Fbio.eff"] <- css.table[,"q50.2"]/css.table[,"q50"]
