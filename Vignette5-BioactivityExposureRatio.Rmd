...
tiff(file = paste0(loc.wd, "/results_for_paper/Fig_TwoPanelBER.tiff"),
...
write.csv(low.fabs.table,file=paste0(loc.wd,"/results_for_paper/Tablepoorlyabsorbedchemcials.csv"))
```