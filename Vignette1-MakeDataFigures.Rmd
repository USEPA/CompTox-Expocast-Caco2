...
```{r analyze_controls_warfarin}
  ...
  FigWarfarinPbaAdjHist <- ggplot(caco2.publish[casrn == " 81-81-2",])+
    ...
    scale_x_log10(labels=scientific_10,limits=c(10^0,10^1.75))+
    theme_bw()+
    gtheme
  #print(g3b)
...
ggsave(file = paste0(loc.wd, "/results_for_paper/Fig_RefChemsforPaper.tiff"),
...
ggarrange(FigPabAdjHist, FigPbaAdjHist, FigEffluxRAdjHist, 
          ...
          ncol = 1, nrow = 3,
          common.legend = TRUE, legend = "bottom")
ggsave(file = paste0(loc.wd, "/results_for_paper/Fig_CacoDataHists.tiff"),
         height = 6.8, width = 6.8, dpi = 600, compression = "lzw")
ggarrange(FigPabAdjHist, FigPbaAdjHist, FigEffluxRAdjHist, 
          labels = c("A", "B", "C"),
          ncol = 1, nrow = 3,
