...
```{r make_recovery_adjustment_figures}
  ...
  FigAdjPabvsRecovery <- ggplot(caco2.adj) +
  ...
  FigPbavsRecovery <- ggplot(caco2.filt) +
    geom_point(aes(x = rec_ba, y = Pba0), 
               fill = "grey90", color = "black",
               size = 3, shape = 16, alpha = 0.5) +
    geom_smooth(aes(x = rec_ba, y = Pba), data=
                      subset(caco2.adj,Pba0>Pab.thresh), method = "lm")+
...
```{r analyze_controls_warfarin}
  min(caco2.adj[casrn == "81-81-2",.(Pab,Pba,Pab0,Pba0)], na.rm = T)
  max(caco2.adj[casrn == "81-81-2",.(Pab,Pba,Pab0,Pba0)], na.rm = T)
  ...
  labl.dt1e <- caco2.perchem[casrn == "81-81-2",.(labl = c(
    ...
    paste0("Total Count: ", ntotal_recba
                                                     ...
                                                     x = 10,
                                                     y = c(10,8,6))]
  FigWarfarinPabAdjHist <- ggplot(caco2.adj[casrn == "81-81-2",])+
  ...
  FigWarfarinPabUnadjHist <- ggplot(caco2.adj[casrn == "81-81-2",])+
  ...
  FigWarfarinPbaAdjHist <- ggplot(caco2.adj[casrn == "81-81-2",])+
  ...
  FigWarfarinPbaUnadjHist <- ggplot(caco2.adj[casrn == "81-81-2",])+
  ...
  FigWarfarinEffluxRAdjHist <- ggplot(caco2.adj[casrn == "81-81-2",])+
  ...
  FigWarfarinEffluxRUnadjHist <- ggplot(caco2.adj[casrn == "81-81-2",])+
  ...
  FigWarfarinFrecabHist <- 
    ggplot(caco2.adj[casrn == "81-81-2",])+
...
```{r analyze_controls_talinolol}
  ...
  FigTalinololPabAdjHist <- ggplot(caco2.adj[casrn == "57460-41-0",])+
    geom_histogram(aes(x = Pab), fill= "grey80", color = "black")+
    ...
    scale_x_log10(labels=scientific_10,limits=c(10^-2.5,10^0.5))+
    theme_bw()+
    gtheme
  print(FigTalinololPabAdjHist)
  
  FigTalinololPabUnadjHist <- ggplot(caco2.adj[casrn == "57460-41-0",])+
    geom_histogram(aes(x = Pab0), fill= "grey80", color = "black")+
  ...
  FigTalinololPbaAdjHist <- ggplot(caco2.adj[casrn == "57460-41-0",])+
    geom_histogram(aes(x = Pba), fill= "grey80", color = "black")+
  ...
  FigTalinololPbaUnadjHist  <- ggplot(caco2.adj[casrn == "57460-41-0",])+
    geom_histogram(aes(x = Pba0), fill= "grey80", color = "black")+
    labs(title = "b) Talinolol",
         y = expression(bold("Count")), 
         x = expression(bolditalic("P"["BA"])~bold('(10'^'-6'~'cm/s)'))) +
  ...
  FigTalinololEffluxRAdjHist <- ggplot(caco2.adj[casrn == "57460-41-0",])+
    geom_histogram(aes(x = efflux.ratio), fill= "grey80", color = "black")+
  ...
  FigTalinololEffluxRUnadjHist <- ggplot(caco2.adj[casrn == "57460-41-0",])+
    geom_histogram(aes(x = efflux0), fill= "grey80", color = "black")+
    labs(title = "b) Talinolol",
         y = expression(bold("Count")), 
         x = expression(bold("Efflux Ratio"))) +
  ...
  FigTalinololFrecabHist <- 
    ggplot(caco2.adj[casrn == "57460-41-0",])+
    geom_histogram(aes(x = rec_ab), fill= "grey80", color = "black")+
...
```{r analyze_controls_ranitidine}
  ...
  FigRanitidinePabAdjHist <- ggplot(caco2.adj[casrn == "66357-35-5",])+
    geom_histogram(aes(x = Pab), fill= "grey80", color = "black")+
  ...
  FigRanitidinePabUnadjHist <- ggplot(caco2.adj[casrn == "66357-35-5",])+
    geom_histogram(aes(x = Pab0), fill= "grey80", color = "black")+
  ...
  FigRanitidinePbaAdjHist <- ggplot(caco2.adj[casrn == "66357-35-5",])+
    geom_histogram(aes(x = Pba), fill= "grey80", color = "black")+
  ...
  FigRanitidinePbaUnadjHist <- ggplot(caco2.adj[casrn == "66357-35-5",])+
    geom_histogram(aes(x = Pba0), fill= "grey80", color = "black")+
    labs(title = "c) Ranitidine",
         y = expression(bold("Count")), 
         x = expression(bolditalic("P"["BA"])~bold('(10'^'-6'~'cm/s)'))) +
  ...
  FigRanitidineEffluxRAdjHist <- 
    ggplot(caco2.adj[casrn == "66357-35-5",])+
  ...
  FigRanitidineEffluxRUnadjHist  <- ggplot(caco2.adj[casrn == "66357-35-5",])+
    geom_histogram(aes(x = efflux0), fill= "grey80", color = "black")+
    labs(title = "c) Ranitidine",
         y = expression(bold("Count")), 
         x = expression(bold("Efflux Ratio"))) +
...
caco2.adj[!is.na(Pab),nrep_pab := .N,.(casrn)]
caco2.dup <- caco2.adj[nrep_pab >= 2,] %>% 
...
caco2.filt2[, Pab.unadj.unfilt := log10(Pab)] %>% 
...
```{r write_final_data}
{
dim(unique(caco2.filt2[,.(casrn, batch_id, t_type)]))
caco2.publish <- caco2.filt2[,.(casrn, batch_id, t_type,
                               Pab.unadj.unfilt,
                               Pba.unadj.unfilt,
                               efflux.unadj.unfilt,
                               rec_ab.unfilt,
                               rec_ba.unfilt)][caco2.filt2, 
                                               on = c("casrn", 
                                                      "batch_id", 
                                                      "t_type")]
